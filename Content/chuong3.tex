\section*{CHƯƠNG 3: TẠO THƯ VIỆN SCHEMATIC VÀ PCB 3D}
\stepcounter{section}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{image/ch3.2.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{image/ch3.4.png}
\end{figure}
Bước 3: Chọn Tools/IPC Compliant Footprint Wizard/Next.
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{image/ch3.5.png}
\end{figure}
Bước 4: Chọn kiểu chân SOP/TSOP và nhấn NEXT.
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{image/ch3.6.png}
\end{figure}
\cleardoublepage
Bước 5: Đọc datasheet của linh kiện để tìm các thông số thiết kế.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{image/ch3.7.png}
\end{figure}
Bước 6: Nhập các thông số vào các ô tương ứng và nhấn NEXT.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{image/ch3.8.png}
\end{figure}
Bước 7: Tiếp tục nhấn NEXT cho đến khi đến màn hình lưu và đặt tên.
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{image/ch3.9.png}
\end{figure}
Bước 8: Chọn Produce 3D/STEP model nhấn NEXT và FINISH.
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{image/ch3.10.png}
\end{figure}
\cleardoublepage
Bước 9: Hoàn thành việc tạo thư viện footprint cho linh kiện LM358 SOP8.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{image/ch3.11a.png}
    \caption{Footprint LM358 SOP8 vừa tạo} 
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{image/ch3.11b.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{image/ch3.12.png}
\end{figure}
Bước 2: Chọn Browse và chọn thư viện PCB tương ứng và nhấn OK
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{image/ch3.13.png}
\end{figure}
\cleardoublepage
Bước 3: Vào File/New chọn Library và chọn Integrated Library.
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{image/ch3.15.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{image/ch3.16.png}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{image/ch3.14.png}
